...
'QTUM', 'RUNE', 'SAND', 'STMX', 'STPT', 'TOMO', 'TROY', 'VITE', 'VTHO', 'WNXM', 'YFII', 
'ADA', 'ANT', 'BAL', 'BCC', 'BLZ', 'BNB', 'BNT', 'BSV', 'BTS', 'BTT', 'CHR', 'CHZ', 'COS', 
'CRV', 'DCR', 'DGB', 'DIA', 'DOT', 'ENJ', 'ERD', 'FET', 'FIO', 'FTM', 'FTT', 'FUN', 'GTO', 
'GXS', 'HOT', 'ICX', 'JST', 'KEY', 'KMD', 'KSM', 'LRC', 'LSK', 'LTO', 'MBL', 'MCO', 'MDT', 
